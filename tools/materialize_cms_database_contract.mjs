...
const baselinePath = path.join(
  root,
  'database/ddl/baseline/postgres/0001_cms_legacy_baseline.sql',
);
...
const prefixRegistry = {
  ...
  prefixes: [{ prefix: 'cms_', owner: 'cms-platform', domain: 'cms' }],
};
...
process.stdout.write(`materialized ${tableNames.length} tables into CMS database contract\n`);
